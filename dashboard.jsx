            ...
            {projects.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  {p.exposed && <Radio size={12} color="#4CAF7D" />}
            ...
            <>
              <div style={styles.detailHead}>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 }}>
                  ...
                  {selected.exposed && (
                    <div style={styles.statusPill("#4CAF7D")}>
                      <Radio size={11} /> Exposé publiquement
                    </div>
                  )}
                </div>
              </div>
              ...
              <div style={styles.actionsRow}>
                ...
                {selected.exposed ? (
                  <button
                    ...
                    disabled={busy}
                  >
                    <Radio size={14} /> Retirer du proxy public
                  </button>
                ) : (
                  <button
                    style={styles.actionBtn}
                    ...
                    title={selected.status !== "running" ? "Déploie d'abord le projet" : ""}
                  >
                    <Radio size={14} /> Exposer publiquement
                  </button>
                )}
